"""
Mr. Scrooge has a sum of money 'P' that he wants to invest. Before he does, he
wants to know how many years 'Y' this sum 'P' has to be kept in the bank in
...
Note to Tax: not the invested principal is taxed, but only the year's accured
interest
...
Thus Mr. Scrooge has to wait for 3 years for the initial principal to amount to
the desired sum.
